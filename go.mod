...
require (
	...
	github.com/openshift/library-go v0.0.0-20230222114049-eac44a078a6e // indirect
	github.com/openshift/oauth-server v0.0.0-alpha.0.0.20220516220728-8d80088ebf85 // indirect
